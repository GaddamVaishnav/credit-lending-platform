...
// Routed through nginx (see nginx-ssl.conf): /api/loan/ -> loan:8082, /api/v1/ -> onboarding:8081
// Relative paths avoid mixed-content blocking on the HTTPS site and don't depend on
// ports 8082/8081 being reachable from the public internet at all.
const LOAN_API    = '/api/loan';
const ONBOARD_API = '/api/v1';
...
@Component({
  ...
  template: `
    <div class="app">
      <!-- Navbar -->
      <nav class="navbar">
        <a routerLink="/" class="nav-brand" style="text-decoration:none">
          <div class="logo">₹</div>
